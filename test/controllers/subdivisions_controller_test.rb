...
class SubdivisionsControllerTest < ActionController::TestCase
  ...
  test "should create subdivision" do
    assert_difference('Subdivision.count') do
      post :create, subdivision: { company_id: @subdivision.company_id, full_name: @subdivision.full_name, name: @subdivision.name }
    end
  ...
  test "should update subdivision" do
    patch :update, id: @subdivision, subdivision: { company_id: @subdivision.company_id, full_name: @subdivision.full_name, name: @subdivision.name }
    assert_redirected_to subdivision_path(assigns(:subdivision))
  end
